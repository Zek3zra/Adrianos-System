...
const PRODUCTS = [
    ...
    createProduct('Drinks Add Ons/Other Drinks', 'Thai Milk Tea', '22oz', 130, 'More To Enjoy / Add Ons', ''),
    createProduct('Drinks Add Ons/Other Drinks', 'Hot Chocolate', '8oz', 70, 'More To Enjoy / Add Ons', ''),
    createProduct('Drinks Add Ons/Other Drinks', 'Mineral Water', '', 25, 'More To Enjoy / Add Ons'),
    createProduct('Drinks Add Ons/Other Drinks', 'Coke in Can', '', 70, 'More To Enjoy / Add Ons'),
    createProduct('Drinks Add Ons/Other Drinks', 'Nata', '', 20, 'More To Enjoy / Add Ons'),
    createProduct('Drinks Add Ons/Other Drinks', 'Cold Foam', '', 20, 'More To Enjoy / Add Ons'),
    createProduct('Drinks Add Ons/Other Drinks', 'Oat Milk', '', 50, 'More To Enjoy / Add Ons'),
    createProduct('Drinks Add Ons/Other Drinks', 'Biscoff Spread', '', 25, 'More To Enjoy'),
    createProduct('Drinks Add Ons/Other Drinks', 'Extra Single Shot Espresso', '', 25, 'More To Enjoy'),
    createProduct('Drinks Add Ons/Other Drinks', 'Extra Double Shot Espresso', '', 50, 'More To Enjoy'),
    ...
    createProduct('Burgers', 'Cheese Burger', '', 145, 'Bun Intended'),
    createProduct('Burgers', 'Chicken Burger', '', 135, 'Bun Intended'),
    createProduct('Burgers', 'Smoked Grilled Burger', '', 150, 'Bun Intended'),
    createProduct('Starters', 'Shawarma Wrap', 'Beef', 85, 'That’s A Wrap'),
    createProduct('Starters', 'Shawarma Wrap', 'Pork', 80, 'That’s A Wrap'),
    createProduct('Starters', 'Shawarma Wrap', 'Chicken', 75, 'That’s A Wrap'),
    ...
    createProduct('Starters', 'Lasagna', 'Pork', 180, 'Rice Meals'),
    createProduct('Starters', 'Lasagna', 'Beef', 200, 'Rice Meals'),
    ...
    createProduct('Pastries', 'Biscoff Cheesecake', '', 190),
    createProduct('Pastries', 'Blueberry Cheesecake', '', 190),
